...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="container">
            <div class="col-md-12">
                <h3><i class="fa fa-wrench"></i> Novo Serviço
            ...
            <form action="<?= base_url()?>gravar-servico" method="post" autocomplete="off">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <label for="servicos_titulo">Título</label>
                        <input type="text" name="servicos_titulo" class="form-control" id="servicos_titulo" required>
                </div>
                ...
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <div>
                        <select name="servicos_icone" class="form-control ">
                ...
                <div class="col-md-6 col-md-offset-3">
                    ...
                    <textarea name="servicos_descricao" id="servicos_descricao" cols="70" rows="5" maxlength="150"></textarea>
                </div>
