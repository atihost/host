...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="container">
            <div class="col-md-12">
                <h3><i class="fa fa-wrench"></i> Novo curso
                    <a href='<?= base_url()?>cursos/' class="btn btn-custom pull-right waves-effect waves-light"><i class="fa fa-chevron-left"></i> Listar Cursos</a></h3>
            </div>
            <hr class="divisor"><br>
            <form action="<?= base_url()?>gerencial/gravar-curso" method="post" autocomplete="off">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <label for="curso_icone">Ícone</label>
                    <div>
                        <select name="curso_icone" class="form-control ">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <label for="descricao">Descrição (max 50 caracteres)</label>
                    <textarea name="descricao" id="descricao" cols="70" rows="5" maxlength="50"></textarea>
                </div>
