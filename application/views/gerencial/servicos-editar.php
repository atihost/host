...
<div class="content-page">
    ...
    <div class="content">
        ...
        <div class="container">
            <div class="col-md-12">
                <h3><i class="fa fa-wrench"></i> Editar Serviço
                    <a href='<?= base_url()?>servicos/' class="btn btn-custom pull-right waves-effect waves-light"><i class="fa fa-chevron-left"></i> Listar Serviços</a></h3>
            </div>
            <hr class="divisor"><br>
            <form action="<?= base_url()?>gravar-servico" method="post" autocomplete="off">

                <input type="hidden" name="servicos_id" value="<?= $servicos['servicos_id']?>">
                <div class="col-md-6 col-md-offset-3">
                    <label for="servicos_titulo">Título</label>
                    <input type="text" name="servicos_titulo" class="form-control" id="servicos_titulo" value="<?= $servicos['servicos_titulo']?>" required>
                </div>

                <div class="row"></div><br>

                <div class="col-md-6 col-md-offset-3">
                    <label for="servicos_icone">Ícone</label>
                    <div>
                        <select name="servicos_icone" class="form-control" id="servicos_icone">
                ...
                <div class="col-md-6 col-md-offset-3">
                    <label for="servicos_descricao">Descrição (max 150 caracteres)</label>
                    <textarea name="servicos_descricao" id="servicos_descricao" cols="70" rows="5" maxlength="150"><?= $servicos['servicos_descricao']?></textarea>
                </div>
...
<script> var icone = "<?= $servicos['servicos_icone']?>"</script>
